...
export default function ModalCommon({ show, size, btnActionCancel, btnActionApproved, loadingApproved = false, loadingCancel = false, closeAction, title, btnTitleApproved = "", btnTitleCancel = "", className, children, loading = false }) {
