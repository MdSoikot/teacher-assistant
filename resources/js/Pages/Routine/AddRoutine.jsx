...
const AddRoutine = () => {
    ...
    const timeFormat = (newVal) => {
        ...
        // let H = +timeString.slice(0, timeString.indexOf(':'));
        // let h = H % 12 || 12;
    ...
    const handleSubmit = (e) => {
        ...
        if (!mapping.length) {
            Inertia.post(route('add_routine'), values, {
                onFinish: () => {
                    setSending(false)
                    setValues({
                        course_title: '',
    ...
    return (
        <div className="main-div">
            <div className="font-inter-600 text-3xl mb-4 flex gap-4">
                <span>Add Personal Class Routine</span>
            </div>
            <form
...
AddRoutine.layout = (page) => <Layout>{page}</Layout>;
